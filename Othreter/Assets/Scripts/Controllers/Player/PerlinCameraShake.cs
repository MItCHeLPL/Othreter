...
public class PerlinCameraShake : MonoBehaviour
{
    ...
    [Range(0, 10)]
    private float _translationMasterMagnitude = 0.15f;
    ...
    [SerializeField]
    private bool _translateAxisZ = true;
    ...
    [SerializeField]
    [Range(0, 1)]
    private float _translateAxisYMultiplier = 0.5f;
    [SerializeField]
    [Range(0, 1)]
	...
	[HideInInspector]
    public bool _shakeJobRunning = false;
